...
const translations = {
  'zh-TW': {
    kevinPaiBio: '在遊戲產業 13 年工作經驗，於眾多遊戲公司任職，曾任線上遊戲「英雄聯盟」台港澳與東南亞區負責人，後續再於各大知名遊戲公司如 Garena, SEA Group, Supercell, Riot Games, Tencent, Funplus, and TESL 擔任總經理、執行長等職位。\n\n熟悉遊戲產業的上下游業務生態，並致力打造更完善的遊戲生態產業鏈 (社群、遊戲發行、行銷、電子競技、數位內容等) 。'
  },
  'en': {
...
function TeamMember({ language = 'zh-TW' }) {
      ...
      <div className="team-members">
        <div className="team-member-card">
          <div 
            ...
            style={{ backgroundImage: 'url(/images/Kevin_Pai_Placeholder.png)' }}
          ></div>
