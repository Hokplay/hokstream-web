...
const translations = {
  'zh-TW': {
    ...
    decentralizedVenue:
      '從單純場域經營升級成內容製作中心、大量內容製作機會訓練製作人才'
  },
  'en-US': {
    ...
    multiLocationCreator:
      'Lower community event production costs, reduced equipment & logistics costs',
    multiLocationVenue:
      'In-store competitions & broadcasts, inter-café events, cross-location company tournaments, etc.',

    // No Learning Threshold Card
    noLearning: 'No Learning Threshold',
    noLearningGamer:
      'More cross-community competitive content, lower online program production costs',
    noLearningCreator:
      'Easier online program production, increased content flexibility, lower clarity costs',
    noLearningVenue:
      'Easily obtain all needed views from inside and outside the venue',

    // No Game Limitations Card
    noGameLimits: 'No Game Limitations',
    noGameLimitsGamer:
      'Save OB development costs, start building competitive communities earlier',
    noGameLimitsCreator:
      'Expand business content, easily broadcast previously difficult SLG nation battles',
    noGameLimitsVenue:
      'Gain self-produced content capabilities, flexible application domains',

    // Decentralized Design Card
    decentralized: 'Decentralized Design',
    decentralizedGamer:
      'Increase community content flexibility, strengthen community-led promotion, reduce advertising pressure',
    decentralizedCreator:
      'Enhance production flexibility, reduce logistics costs',
    decentralizedVenue:
      'Upgrade from simple venue operations to content production center, training opportunities for production talent'
  }
};
...
function FeatureCards() {
  ...
  function getFeatureContent(featureKey: FeatureKey) {
    switch (activeTab) {
      case 'gamer':
      ...
      <div className="container">
        ...
        <div className="feature-cards-grid">
          ...
          <div className="feature-card">
            ...
            <p className="feature-description">
              {getFeatureContent('decentralized')}
            </p>
          </div>
        </div>
      </div>
