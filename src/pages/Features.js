...
const translations = {
  'zh-TW': {
    ...
    multiSceneLiveDesc: '同時管理多個場景的直播製作，無需額外的設備或人力，充分利用您的資源並提高效率',
    noLearningThreshold: '無學習門檻',
    noLearningThresholdDesc: '即使沒有專業技術知識的用戶，也可以輕鬆上手使用我們的平台，開始創建令人驚嘆的直播內容',
    noGameLimitations: '不限游戲屬性',
    noGameLimitationsDesc: '管理遊戲屬性，可以與任意多個不同遊戲中的不同屬性連接，並與我們的平台集成，提供全面的遊戲直播體驗',
    decentralizedDesign: '去中心化設計',
    decentralizedDesignDesc: '我們採用去中心化設計理念，確保沒有單點故障，並在系統某一部分出現問題時提供冗餘，提高可靠性和可用性',
    moreFeatures: '還在新增....',
    all: '全部',
    game: '遊戲',
    live: '直播',
  ...
  'en': {
    ...
    modernLiveProductionDesc: 'Efficient live production process without extra professional knowledge required',
    resourceManagement: 'Resource Management',
    resourceManagementDesc: 'Comprehensive and simple management of your materials and resources',
    dataAnalyticsCenter: 'Data Analytics Center',
    dataAnalyticsCenterDesc: 'Comprehensive data analysis and reporting to make data-driven decisions',
    contentProtection: 'Digital Protection Measures',
    contentProtectionDesc: 'Protect your content and intellectual property from unauthorized use',
    unlimitedFlexibility: 'Unlimited Flexibility',
    unlimitedFlexibilityDesc: 'Customize and extend the platform according to your specific needs',
    enhancedCollaboration: 'Enhanced Collaboration',
    enhancedCollaborationDesc: 'Facilitate seamless collaboration between team members, regardless of their location',
    ...
    singlePersonMultiCameraDesc: 'One person can control multiple cameras, increasing efficiency and reducing manpower costs',
    intelligentDirecting: 'Intelligent Directing Framework',
    intelligentDirectingDesc: 'Intuitive directing tools that make live broadcast direction work easier and more efficient',
    templateLibrary: 'Template Library Presets',
    templateLibraryDesc: 'Use preset templates to quickly start your projects, saving time and effort',
    customTemplateFunction: 'Custom Preset Template Features',
    customTemplateFunctionDesc: 'Create and save your own templates for future use and brand consistency',
    gameControlTools: 'Game Automation Control Tools',
    social: 'Social Media',
    socialDesc: 'Seamlessly distribute your content across different social media platforms, expanding your reach',
    internalNetwork: 'Internal Network',
    internalNetworkDesc: 'Easily share content through the internal network, ensuring team members always stay in sync',
    multiSceneLive: 'Multi-scene Live Production',
    multiSceneLiveDesc: 'Manage multi-scene live productions simultaneously without extra equipment or manpower, maximizing your resources and efficiency',
    noLearningThreshold: 'No Learning Threshold',
    noLearningThresholdDesc: 'Users without technical expertise can easily start using our platform and create amazing live content',
    noGameLimitations: 'No Game Property Limitations',
    noGameLimitationsDesc: 'Manage game properties, connect with any number of different properties in different games, and integrate with our platform for a comprehensive game streaming experience',
    decentralizedDesign: 'Decentralized Design',
    decentralizedDesignDesc: 'We adopt a decentralized design philosophy to ensure no single point of failure and provide redundancy if one part of the system has issues, increasing reliability and availability',
...
function Features({ language }) {
  ...
  return (
    <div className="features-page">
          ...
          <div className="highlights-grid">
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconLive || "/images/icon-placeholder.png"} alt="Live Production" />
              </div>
            ...
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconResource || "/images/icon-placeholder.png"} alt="Resource Management" />
              </div>
              <div className="highlight-content">
            ...
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconAnalytics || "/images/icon-placeholder.png"} alt="Data Analytics" />
              </div>
              <div className="highlight-content">
            ...
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconProtection || "/images/icon-placeholder.png"} alt="Content Protection" />
              </div>
              <div className="highlight-content">
            ...
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconFlexibility || "/images/icon-placeholder.png"} alt="Flexibility" />
              </div>
              <div className="highlight-content">
            ...
            <div className="highlight-item">
              <div className="highlight-icon">
                <img src={images.iconCollaboration || "/images/icon-placeholder.png"} alt="Collaboration" />
              </div>
              <div className="highlight-content">
      ...
      <VideoProcessing language={language} />
      {/* Additional Features */}
      <section className="additional-features">
        <div className="container">
          <div className="feature-item">
            <div className="feature-image">
              <img src={images.broadcastSetup} alt="Multi-scene live production" />
            </div>
          ...
          <div className="feature-item">
            <div className="feature-image">
              <img src={images.videoProcessing} alt="No learning threshold - Video Processing App" />
            </div>
            <div className="feature-text">
  ...
  <div className="feature-image game-collage-image">
    <img src={images.gameCollage} alt="Various game types supported" />
  </div>
  <div className="feature-text">
